...
public class InvestMoneyUpiActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public boolean CheckingPermissionIsEnabledOrNot() {
        ...
        int CAMERA_PermissionResult = ContextCompat.checkSelfPermission(InvestMoneyUpiActivity.this, CAMERA);
        int READ_EXTERNAL_STORAGE_PermissionResult = ContextCompat.checkSelfPermission(InvestMoneyUpiActivity.this, READ_EXTERNAL_STORAGE);
        int WRITE_EXTERNAL_STORAGE_PermissionResult = ContextCompat.checkSelfPermission(InvestMoneyUpiActivity.this, WRITE_EXTERNAL_STORAGE);
            ...
            case RequestPermissionCode:
                if (grantResults.length > 0) {
                    ...
                    if (StoragePermission && RecordPermission) {
                        Toast.makeText(InvestMoneyUpiActivity.this, "Permission Granted",
                                Toast.LENGTH_LONG).show();
                    } else {
                        Toast.makeText(InvestMoneyUpiActivity.this, "Permission Denied", Toast.LENGTH_LONG).show();
                    }
                }
                break;
        }
